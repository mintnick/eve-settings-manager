...
При запуске приложение автоматически ищет папку настроек EVE. Если она не найдена или требуется указать другое расположение, нажмите кнопку **Вручную выбрать папку настроек**.
