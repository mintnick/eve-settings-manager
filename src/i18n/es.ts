export default {
  ...
  info: {
    ...
    dataHeading: 'Datos locales',
    dataDesc: 'Los datos de la app (copias de seguridad, notas, preferencias) se almacenan localmente. No se envía nada a ningún servidor.',
    dataLabel: 'Ubicación:',
    close: 'Cerrar',
  },
  profile: {
