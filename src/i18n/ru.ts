export default {
  ...
  info: {
    ...
    dataHeading: 'Локальные данные',
    dataDesc: 'Данные приложения (резервные копии, заметки, настройки) хранятся локально. Ничего не отправляется на серверы.',
    dataLabel: 'Расположение:',
    close: 'Закрыть',
  },
  profile: {
