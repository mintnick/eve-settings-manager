export default {
  ...
  info: {
    ...
    macHeading: 'macOS: предупреждение «Повреждён»',
    macDesc: 'Приложение не имеет цифровой подписи. Если macOS блокирует его с сообщением «повреждён и не может быть открыт», выполните эту команду в Терминале, затем откройте приложение обычным способом:',
    close: 'Закрыть',
  },
  profile: {
